...
- Modify `src/devteam/config/agents.yaml` to define your agents
- Modify `src/devteam/config/tasks.yaml` to define your tasks
- Modify `src/devteam/crew.py` to add your own logic, tools and specific args
- Modify `src/devteam/main.py` to add custom inputs for your agents and tasks
